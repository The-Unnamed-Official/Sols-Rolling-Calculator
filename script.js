...
const auras = [
    ...
    { name: "Erebus - 1,200,000,000", chance: 1200000000, cutscene: "erebus-cs", exclusiveTo: ["bloodrain"] },
    { name: "Pixelation - 1,073,741,824", chance: 1073741824, cutscene: "pixelation-cs" },
    { name: "Lamenthyr - 1,000,000,000", chance: 1000000000, cutscene: "lamenthyr-cs", exclusiveTo: ["bloodrain"] },
    { name: "Arachnophobia - 940,000,000", chance: 940000000, exclusiveTo: ["pumpkinmoon2025"] },
    { name: "Ravage - 930,000,000", chance: 930000000, exclusiveTo: ["graveyard2025"] },
    ...
    { name: "Malediction - 730,000,000", chance: 730000000, exclusiveTo: ["bloodrain"] },
    { name: "Banshee - 730,000,000", chance: 730000000, exclusiveTo: ["graveyard2025"] },
    ...
    { name: "Apocalypse - 624,000,000", chance: 624000000, exclusiveTo: ["graveyard2025"] },
    ...
    { name: "Phantasma - 462,000,000", chance: 462000000, exclusiveTo: ["pumpkinmoon2025"] },
    ...
    { name: "Accursed - 82,000,000", chance: 82000000, exclusiveTo: ["bloodrain"] },
    ...
    { name: "Headless : Horseman - 32,000,000", chance: 32000000, exclusiveTo: ["pumpkinmoon2025"] },
    ...
    { name: "Sinister - 15,000,000", chance: 15000000, exclusiveTo: ["pumpkinmoon2025"] },
    ...
    { name: "Oni - 6,666,666", chance: 6666666, exclusiveTo: ["bloodrain"] },
    ...
    { name: "Headless - 3,200,000", chance: 3200000, exclusiveTo: ["graveyard2025"] },
    ...
    { name: "Pump : Trickster - 600,000", chance: 600000, exclusiveTo: ["pumpkinmoon2025"] },
...
const EVENT_AURA_MAP = {
    ...
    halloween2025: [
        ...
        "Arachnaphobia - 930,000,000",
        "Ravage - 930,000,000",
        "Malediction - 730,000,000",
        "Ravage - 730,000,000",
        "Apocalypse - 624,000,000",
        "Phantasma - 462,000,000",
        "Accursed - 82,000,000",
...
const BIOME_EVENT_REQUIREMENTS = {
    ...
    blazing: "summer2025",
    graveyard2025: ["halloween2025"],
    pumpkinmoon2025: ["halloween2025"],
...
const cutscenePriority = ["oblivion-cs", "memory-cs", "equinox-cs", "lumi-cs", "erebus-cs", "Lamenthyr-cs", "pixelation-cs", "dreammetric-cs", "oppression-cs", "glitch-cs"];
...
function roll() {
    ...
    function processChunk() {
        ...
        if (currentRoll < total) {
            ...
            if (highestChance >= 999999999) {
                playSound(document.getElementById('1bSound'));
            } else if (highestChance >= 99999999) {
                if (biome === 'limbo') {
